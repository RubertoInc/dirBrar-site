...
export const musicVideoProjects: MusicVideoProject[] = [
  ...
  },
  {
    ...
    seoCredit: "Produced & Edited by Damen R. Brar",
    summary:
      "The official music video for “Choose U” by Jacob Hayden, produced and edited by Damen R. Brar.",
    ...
    creditGroups: [
      {
        ...
        credits: [
          ...
          { role: "Producer / Editor", name: "Damen R. Brar" },
        ],
      },
    ],
  },
